...
-(void)dealloc {
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"scrollViewButtonViewLeft" object:nil];
}
...
- (void)rightUtilityButtonHandler:(id)sender {
    ...
    if ([self.delegate respondsToSelector:@selector(swippableTableViewCell:didTriggerRightUtilityButtonWithIndex:)]) {
        [self.delegate swippableTableViewCell:self didTriggerRightUtilityButtonWithIndex:utilityButtonTag];
    }
}
...
- (void)leftUtilityButtonHandler:(id)sender {
    UIButton *utilityButton = (UIButton *)sender;
    NSInteger utilityButtonTag = [utilityButton tag];
    if ([self.delegate respondsToSelector:@selector(swippableTableViewCell:didTriggerLeftUtilityButtonWithIndex:)]) {
        [self.delegate swippableTableViewCell:self didTriggerLeftUtilityButtonWithIndex:utilityButtonTag];
    }
}
...
- (void)hideUtilityButtonsAnimated:(BOOL)animated {
    ...
    if ([self.delegate respondsToSelector:@selector(swippableTableViewCell:scrollingToState:)]) {
        [self.delegate swippableTableViewCell:self scrollingToState:kCellStateCenter];
    }
}
...
- (void)scrollToRight:(inout CGPoint *)targetContentOffset{
    ...
    if ([self.delegate respondsToSelector:@selector(swippableTableViewCell:scrollingToState:)]) {
        [self.delegate swippableTableViewCell:self scrollingToState:kCellStateRight];
    }
}
...
- (void)scrollToLeft:(inout CGPoint *)targetContentOffset{
    ...
    if ([self.delegate respondsToSelector:@selector(swippableTableViewCell:scrollingToState:)]) {
        ...
        [self.delegate swippableTableViewCell:self scrollingToState:kCellStateLeft];
    }
}
